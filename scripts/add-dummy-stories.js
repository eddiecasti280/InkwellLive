// Script to add dummy stories to the database
// Run this with: node scripts/add-dummy-stories.js
...
const YOUR_USER_ID = "YOUR_USER_ID_HERE"; // Replace this with your actual user ID
...
async function addDummyStories() {
  if (YOUR_USER_ID === "YOUR_USER_ID_HERE") {
    console.log('❌ Please replace YOUR_USER_ID_HERE with your actual user ID');
    console.log('You can find your user ID in the browser console when logged in');
    return;
  }
  
  console.log('Adding dummy stories to the database...');
  ...
  console.log('Finished adding dummy stories!');
}

// Run the script
addDummyStories().catch(console.error); 