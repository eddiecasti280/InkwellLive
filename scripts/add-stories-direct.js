// Script to add stories directly to the database
// Run this with: node scripts/add-stories-direct.js
...
const dummyStories = [
  {
    ...
    user_id: "57a81547-3e18-41e4-9b78-568010f7a183" // Our new dummy user ID
  },
  {
...
async function addStoriesDirect() {
  console.log('Adding stories directly to the database...');
  ...
  console.log('\n🎉 Finished adding stories!');
  console.log('Check your Browse Community page to see the stories.');
}

// Run the script
addStoriesDirect().catch(console.error); 